...
import 'main.dart'; // Mengimpor SplashScreen dari main.dart
import 'Register.dart'; // Mengimpor RegisterScreen
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final width = MediaQuery.of(context).size.width; // Mendapatkan lebar layar
            ...
            children: [
              ...
              Align(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 12, color: Colors.grey[700]), // Gaya teks
                ),
              ),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (_) => const SplashScreen()), // Navigasi ke SplashScreen
                    );
                  },
              ...
              Row(
                ...
                children: [
                  Text("Belum punya akun?", style: TextStyle(color: Colors.grey[700])), // Teks untuk pendaftaran
                  const SizedBox(width: 4), // Jarak horizontal
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const RegisterScreen()), // Navigasi ke RegisterScreen
                      );
                    },
                    child: const Text(
                      "Daftar", // Teks untuk mendaftar
                      style: TextStyle(
                        color: Color(0xFFF6D365), // Warna teks
